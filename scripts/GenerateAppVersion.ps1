...
$SourcesPath = (Resolve-Path -Path "$RootPath\src").Path
...
#ifdef _RELEASE
unsigned int pshollow::version::major  = {1};
unsigned int pshollow::version::minor  = {2};
unsigned int pshollow::version::build  = {3};
unsigned int pshollow::version::rev    = release;
std::string  pshollow::version::sha    = `"{5}`";
std::string  pshollow::version::branch = `"{6}`";
#else
unsigned int pshollow::version::major  = {1};
unsigned int pshollow::version::minor  = {2};
unsigned int pshollow::version::build  = {3};
unsigned int pshollow::version::rev    = {4};
std::string  pshollow::version::sha    = `"{5}`";
std::string  pshollow::version::branch = `"{6}`";
#endif // _RELEASE
"@
